...
assert.match(html, /id="app-version">v25\.4\.77</, '界面版本必须标记本次修复');
...
assert.match(html, /js\/story-visual-ui\.js\?v=20260827-10/, '可视化编辑器界面模块必须刷新缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260827-11/, '选项编辑界面样式必须刷新缓存标识');
