...
assert.match(html, /id="app-version">v25\.4\.74</, '界面版本必须标记本次修复');
...
assert.match(html, /js\/story-visual-ui\.js\?v=20260827-07/, '可视化编辑器界面模块必须刷新缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260827-10/, '正文段落框样式必须刷新缓存标识');
