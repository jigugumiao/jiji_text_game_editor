...
assert.match(html, /id="app-version">v25\.4\.92</, '界面版本必须标记本次修复');
assert.match(html, /js\/exporter\.js\?v=20260819-02/, '修复运行时后必须刷新 exporter.js 缓存标识');
assert.match(html, /js\/editor\.js\?v=20260911-04/, 'Agent 可写创作设定/外观后必须刷新 editor.js 缓存标识');
...
assert.match(html, /js\/agent\.js\?v=20260911-04/, 'Agent 可写创作设定/外观后必须刷新 agent.js 缓存标识');
