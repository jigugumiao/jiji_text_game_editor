...
assert.match(html, /js\/exporter\.js\?v=20260827-05/, '修复运行时后必须刷新 exporter.js 缓存标识');
assert.match(html, /js\/editor\.js\?v=20260829-02/, '右键变量插入功能必须刷新 editor.js 缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260829-01/, '右键变量插入功能必须刷新样式缓存标识');
