...
assert.match(html, /id="app-version">v25\.4\.73</, '界面版本必须标记本次修复');
...
assert.match(html, /js\/story-visual-ui\.js\?v=20260827-06/, '可视化编辑器界面模块必须刷新缓存标识');
assert.match(html, /js\/exporter\.js\?v=20260827-02/, '修复运行时后必须刷新 exporter.js 缓存标识');
assert.match(html, /js\/editor\.js\?v=20260827-10/, '转换提示修复必须刷新 editor.js 缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260827-09/, '可视化 chip 样式必须刷新缓存标识');
