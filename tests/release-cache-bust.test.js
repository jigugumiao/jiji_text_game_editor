...
assert.match(html, /id="app-version">v25\.4\.67</, '界面版本必须标记本次修复');
...
assert.match(html, /js\/editor\.js\?v=20260827-07/, '转换入口必须刷新 editor.js 缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260827-05/, '转换提示样式必须刷新缓存标识');
