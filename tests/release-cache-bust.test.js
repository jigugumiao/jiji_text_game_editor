...
assert.match(html, /id="app-version">v25\.4\.112/, '界面版本必须标记本次合并');
...
assert.match(html, /js\/editor\.js\?v=20260917-03/, '外观重构与叠层投影后必须刷新 editor.js 缓存标识');
...
assert.match(html, /css\/style\.css\?v=20260917-03/, '外观重构与叠层投影样式后必须刷新 style.css 缓存标识');
