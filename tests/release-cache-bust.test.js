...
assert.match(html, /id="app-version">v25\.4\.95</, '界面版本必须标记本次合并');
...
assert.match(html, /js\/editor\.js\?v=20260912-01/, '合并后必须刷新 editor.js 缓存标识');
...
assert.match(html, /js\/agent\.js\?v=20260912-01/, 'Agent 功能合并后必须刷新 agent.js 缓存标识');
